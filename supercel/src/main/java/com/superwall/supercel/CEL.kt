...
@Structure.FieldOrder("computedProperty", "uniffiFree")
internal open class UniffiVTableCallbackInterfaceHostContext(
    ...
    ) : UniffiVTableCallbackInterfaceHostContext(`computedProperty`, `uniffiFree`),
        Structure.ByValue
...
internal interface UniffiLib : Library {
    ...
    fun uniffi_cel_eval_fn_clone_hostcontext(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun uniffi_cel_eval_fn_free_hostcontext(
        `ptr`: Pointer,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit
    ...
    fun uniffi_cel_eval_fn_method_hostcontext_computed_property(
        `ptr`: Pointer,
        `name`: RustBuffer.ByValue,
        `args`: RustBuffer.ByValue,
    ): Long
    ...
    fun ffi_cel_eval_rustbuffer_alloc(
        `size`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_cel_eval_rustbuffer_from_bytes(
        `bytes`: ForeignBytes.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_cel_eval_rustbuffer_free(
        `buf`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit

    fun ffi_cel_eval_rustbuffer_reserve(
        `buf`: RustBuffer.ByValue,
        `additional`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_cel_eval_rust_future_poll_u8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_cel_eval_rust_future_cancel_u8(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_free_u8(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_complete_u8(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    fun ffi_cel_eval_rust_future_poll_i8(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_cel_eval_rust_future_cancel_i8(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_free_i8(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_complete_i8(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Byte

    fun ffi_cel_eval_rust_future_poll_u16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_cel_eval_rust_future_cancel_u16(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_free_u16(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_complete_u16(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Short

    fun ffi_cel_eval_rust_future_poll_i16(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_cel_eval_rust_future_cancel_i16(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_free_i16(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_complete_i16(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Short

    fun ffi_cel_eval_rust_future_poll_u32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_cel_eval_rust_future_cancel_u32(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_free_u32(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_complete_u32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Int

    fun ffi_cel_eval_rust_future_poll_i32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_cel_eval_rust_future_cancel_i32(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_free_i32(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_complete_i32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Int

    fun ffi_cel_eval_rust_future_poll_u64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_cel_eval_rust_future_cancel_u64(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_free_u64(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_complete_u64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Long

    fun ffi_cel_eval_rust_future_poll_i64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_cel_eval_rust_future_cancel_i64(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_free_i64(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_complete_i64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Long

    fun ffi_cel_eval_rust_future_poll_f32(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_cel_eval_rust_future_cancel_f32(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_free_f32(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_complete_f32(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Float

    fun ffi_cel_eval_rust_future_poll_f64(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_cel_eval_rust_future_cancel_f64(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_free_f64(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_complete_f64(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Double

    fun ffi_cel_eval_rust_future_poll_pointer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_cel_eval_rust_future_cancel_pointer(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_free_pointer(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_complete_pointer(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Pointer

    fun ffi_cel_eval_rust_future_poll_rust_buffer(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_cel_eval_rust_future_cancel_rust_buffer(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_free_rust_buffer(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_complete_rust_buffer(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun ffi_cel_eval_rust_future_poll_void(
        `handle`: Long,
        `callback`: UniffiRustFutureContinuationCallback,
        `callbackData`: Long,
    ): Unit

    fun ffi_cel_eval_rust_future_cancel_void(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_free_void(`handle`: Long): Unit

    fun ffi_cel_eval_rust_future_complete_void(
        `handle`: Long,
        uniffi_out_err: UniffiRustCallStatus,
    ): Unit
    ...
    fun ffi_cel_eval_uniffi_contract_version(): Int
}
    ...
    override suspend fun `computedProperty`(
        ...
        uniffiRustCallAsync(
            ...
            },
            {
                    ...
                    continuation,
                ->
                UniffiLib.INSTANCE.ffi_cel_eval_rust_future_poll_rust_buffer(future, callback, continuation)
            },
...
internal object uniffiCallbackInterfaceHostContext {
    internal object `computedProperty` : UniffiCallbackInterfaceHostContextMethod0 {
        override fun callback(
            ...
            val makeCall =
                suspend {  uniffiObj.`computedProperty`(
    ...
    internal var vtable =
        UniffiVTableCallbackInterfaceHostContext.UniffiByValue(
            `computedProperty`,
            uniffiFree,
        )
...
public object FfiConverterTypeHostContext : FfiConverter<HostContext, Pointer> {
    ...
    override fun lower(value: HostContext): Pointer = Pointer(handleMap.insert(value))

    override fun lift(value: Pointer): HostContext = HostContextImpl(value)
...
fun `evaluateWithContext`(
    ...
    FfiConverterString.lift(
        uniffiRustCall { _status ->
            Log.e("Uniffi", "Calling uniffi_cel_eval_fn_func_evaluate_with_context -> $_status")
            UniffiLib.INSTANCE.uniffi_cel_eval_fn_func_evaluate_with_context(
                FfiConverterString.lower(`definition`),
                FfiConverterTypeHostContext.lower(`context`),
                _status,
            ).apply {
                Log.e("Uniffi", "Got result -> $this")
            }
        },
    )
